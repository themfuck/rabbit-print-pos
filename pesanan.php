                    ...
                    <div class="box-body">
                        <div id="inputBarang" class="col-md-12" style="padding: 0">
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" id="no_surat_jalan" class="form-control" value="" placeholder="No. Surat Jalan dari Pelanggan">
                                <input type="hidden" id="jenis_pesanan" value="">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="nama_pelanggan">Pelanggan</label>
                                <div class="input-group">
                                    <input type="text" id="nama_pelanggan" name="nama_pelanggan" class="form-control" placeholder="Nama Pelanggan" disabled>
                                    <div class="input-group-addon" data-toggle="modal" data-target="#modal-pelanggan">
                                        <i class="fa fa-user"></i>
                                    </div>
                                </div>
                                <input type="text" style="display: none" id="no_pelanggan">
                            </div>
                            <div class="form-group col-md-3">
                                <label>Tgl Masuk Barang</label>
                                <div class="input-group date">
                                    <input type="text" class="form-control pull-right" id="tgl_pesanan" value="" placeholder="Tanggal pesanan diterima">
...
$(function() {
        ...
        "columnDefs": [
            {
                'targets' : -1,
                'data'    : null,
                'defaultContent' : '<button style="margin-left: 3px" class="btn btn-danger btnDelete"><i class="fa fa-trash"></i></button>'
            }, 
    ...
    $('#tabel_detail_pesanan tbody').on('click', 'button', function () {
        var data = tabel.row($(this).parents('tr')).data();
        var pesanan_id = data[1];
        var btnType = tabel.row($(this).parents('tr')).selector.rows.prevObject["0"].classList[2];
        var tabeldata = tabel.rows().data();
        var tabelLength = tabeldata.length;
