      ...
      <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
               <span aria-hidden="true">&times;</span></button>
               <h4 class="modal-title">Hapus invoice ini ?</h4>
            </div>
            <div class="box-body" style="padding: 15px">
              <div class="col-md-12" style="padding-left: 0">
                 <p class="col-md-4" style="padding-left: 0"><strong>No. Invoice</strong></p>
              ...
              <div class="col-md-12" style="padding-left: 0">
                 <p class="col-md-4" style="padding-left: 0"><strong>Harga</strong></p>
...
<script>
    ...
    function hapusPelanggan(no, key) {
      ...
      $.ajax({
        ...
        success: function(response) {
          if (response.response_code == "00") {
                      showSuccessMessage('Invoice berhasil di hapus.');
                  } else {
                      showFailedMessage(response.response_msg);
                  }
        },
        failed : function() {
            showFailedMessage('Hapus Invoice Gagal.');
        },
        error : function() {
            showFailedMessage('Hapus Invoice Gagal 2.');
        }
      });
    }
