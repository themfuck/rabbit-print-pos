...
<h3>SURAT JALAN</h3>
<table width="1000" border="0" cellspacing="0" cellpadding="3" style="margin-bottom: 30px">
    <tr>
        <td class="main_rows" width="130">No. Pengiriman</td>
        <td class="main_rows" width="150">'.$nomor_suratjalan.'</td>
        <td class="main_rows" width="50"></td>
        <td class="main_rows" width="130">Tanggal Kirim</td>
        <td class="main_rows" width="150">'.$tgl_kirim.'</td>
    </tr>
    <tr>
        <td class="main_rows" width="130" valign="top">No. Surat Jalan</td>
        <td class="main_rows" width="150">'.$nomor_suratjalan_mn.'</td>
        <td class="main_rows" width="50"></td>
        <td class="main_rows" width="130">Kepada</td>
        <td class="main_rows" width="200">'.$nama_pelanggan.'</td>
    </tr>
    <tr>
        <td class="main_rows" width="130" valign="top"></td>
        <td class="main_rows" width="150"></td>
        <td class="main_rows" width="50"></td>
        <td class="main_rows" width="130">Alamat</td>
        <td class="main_rows" width="200">'.$alamat_pelanggan.'</td>
    </tr>
</table>
<table border="0.3" cellspacing="0" class="tabel">
    <thead>
        <tr>
            <th valign="middle" height="20" width="30">No</th>
            <th valign="middle" height="20" width="300">Nama Barang</th>
            <th valign="middle" height="20" width="50">QTY</th>
            <th valign="middle" height="20" width="50">Satuan</th>
            <th valign="middle" height="20" width="250">Keterangan</th>
        </tr>
    </thead>';
    ...
    if ($jenis_pesanan == "U") {
        ...
        foreach ($list_table_detail as $vl) {
            ...
            . "<tr>"
                ...
                . "<td style='width: 40px'> " . $vl["detail_pesanan_detail_kain"] . " </td>"
...
<tfoot>
    <tr>
        ...
        <td valign="middle" height="20" align="left">Total</td>
        <td valign="middle" height="20" align="center">'.$totalqty.'</td>
        <td></td>
        <td></td>
    </tr>
</tfoot>
...
<table width="1000" border="0" cellspacing="0" cellpadding="3" style="bottom: 10;">
    <tr>
        <td align="center" class="main_rows" width="240">Tanda Tangan Penerima</td>
        <td class="main_rows" width="240"></td>
        <td class="main_rows" width="240"></td>
    </tr>
    <tr>
        <td align="center" valign="bottom" class="main_rows" width="240" height="40">.........................................</td>
        <td class="main_rows" width="240"></td>
        <td class="main_rows" width="240"></td>
    </tr>
    <tr>
        <td align="center" class="main_rows" width="240">Dibuat Oleh</td>
        <td align="center" class="main_rows" width="240">Disetujui Oleh</td>
        <td align="center" class="main_rows" width="240">Disetujui Oleh</td>
    </tr>
    <tr>
        <td align="center" valign="bottom" class="main_rows" width="240" height="40">.........................................</td>
